...
[stock_warehouse_replenishment_alert_send_message](stock_warehouse_replenishment_alert_send_message/) | 17.0.1.0.0 |  | Send a message for the responsible if Quantity drops below its minimum quantity in replenishments
