...
[![Pre-commit Status](https://github.com/tawasta/stock/actions/workflows/pre-commit.yml/badge.svg?branch=17.0)](https://github.com/tawasta/stock/actions/workflows/pre-commit.yml?query=branch%3A17.0)
[![Build Status](https://github.com/tawasta/stock/actions/workflows/test.yml/badge.svg?branch=17.0)](https://github.com/tawasta/stock/actions/workflows/test.yml?query=branch%3A17.0)
...
[stock_picking_note_indicator](stock_picking_note_indicator/) | 17.0.1.0.0 |  | Stock Picking Note Indicator
...
[stock_picking_show_move_destination_location_column](stock_picking_show_move_destination_location_column/) | 17.0.1.0.1 |  | Enables destination location editing per stock move
[stock_picking_show_move_source_location_column](stock_picking_show_move_source_location_column/) | 17.0.1.0.0 |  | Enables source location editing per stock move
...
[stock_report_delivery_slip_default_location](stock_report_delivery_slip_default_location/) | 17.0.1.0.1 |  | Show informative Default Location of a product in Delivery Slip
...
[stock_valuation_average_price_update_by_percentage](stock_valuation_average_price_update_by_percentage/) | 17.0.1.0.1 |  | Set a factor by which stock valuation is updated with average price
